...
function renderSlotGrid(loadout, opts = {}) {
  ...
  const slotHtml = SLOTS.map(slot => {
    ...
    return keys.map((key, ki) => {
      ...
      const sourceHtml = showSource ? (sources.length
